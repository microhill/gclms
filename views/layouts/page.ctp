...
<html xmlns="http://www.w3.org/1999/xhtml" lang="<?= $language ?>" dir="<? __('TEXT DIRECTION'); ?>">
	...
	>
		...
		<script type="text/javascript" src="/js/vendors/scriptaculous1.8/scriptaculous.js"></script>
		<script type="text/javascript" src="/js/vendors/scriptaculous1.8/effects.js"></script>
		<script type="text/javascript" src="/js/vendors/scriptaculous1.8/dragdrop.js"></script>
		<script type="text/javascript" src="/js/vendors/scriptaculous1.8/slider.js"></script>
