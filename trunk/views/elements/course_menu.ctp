<?= $this->element('menu', array("items" => array(
	...
	Permission::check('Course') ? array('label' => __('Files', true), 'class' => 'gclms-files', 'active' => $this->name == 'Files', 'url' => $groupAndCoursePath . '/files') : null,
	...
	Permission::check('Course') ? array('label' => __('Configure Course', true), 'class' => 'gclms-configuration', 'active' => $this->name == 'Courses' && $this->action == 'edit', 'url' => $groupAndCoursePath . '/configuration') : null,
	Permission::check('Course') ? array('label' => __('Export Course', true), 'class' => 'gclms-export', 'active' => $this->name == 'Export', 'url' => $groupAndCoursePath . '/export') : null
)));