<ul class="gclms-primary-column-menu">
	<?= $this->element('menu', array("items" => array(
			...
			Permission::check('SiteAdministration') ? array('controller'=>'administration','url' => '/administration','label'=>__('Site Administration', true),'class'=>'gclms-administration') : null
		)));
	?>
</ul>