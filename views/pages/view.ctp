	...
	<div class="gclms-page gclms-noframes">
		...
		<div id="gclms-page-navigation">
			...
			<? if(!empty($node['Node']['previous_page_id'])): ?>
				<a class="gclms-back" href="<?= $groupAndCoursePath ?>/pages/view/<?= $node['Node']['previous_page_id'] ?><?= $framed ? '?framed' : '' ?>">
			...
			<? if(!empty($node['Node']['next_page_id'])): ?>
				<a class="gclms-next" href="<?= $groupAndCoursePath ?>/pages/view/<?= $node['Node']['next_page_id'] ?><?= $framed ? '?framed' : '' ?>">
