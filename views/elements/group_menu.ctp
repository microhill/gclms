...
echo $this->renderElement('menu', array("items" => array(
	...
	array('controller' => 'FacilitatedClasses', 'class' => 'gclms-courses', 'label' => __('Facilitated Classes', true),'url'=>'/' . $this->params['group'] . '/facilitated_classes', 'active' => $this->viewPath == 'facilitated_classes'),
	...
	array('controller' => 'Facilitators2','label' => __('Register as Facilitator', true),'class' => 'gclms-register','url' => '/' . $group['web_path'] . '/facilitators/register', 'active' => $this->viewPath == 'facilitators' && $this->action == 'register'),
